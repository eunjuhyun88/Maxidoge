...
const storeMeta = [
  ...
  ['walletStore', 'route/session transient', 'wallet connection transport and signed-wallet shell', 'Consumes session and lifecycle projections but should not own either authority.'],
