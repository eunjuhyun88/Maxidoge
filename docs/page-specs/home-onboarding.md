...
Purpose:
- Define the landing-page contract as it exists now: hero exploration plus direct handoff into Terminal or wallet-gated Arena.

## Primary User Job

- Understand the product promise from the hero without leaving the page.
- Explore one feature path quickly and reach Terminal or Arena from the hero CTA group.
