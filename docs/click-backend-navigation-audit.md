...
- UI: `/Users/ej/Downloads/maxi-doge-unified/src/components/modals/WalletModal.svelte:19`
- Local simulation call path: `/Users/ej/Downloads/maxi-doge-unified/src/lib/stores/walletStore.ts:127`
- Existing server endpoints exist but are not used by this UI path:
  - `/Users/ej/Downloads/maxi-doge-unified/src/routes/api/auth/register/+server.ts:3`
  - `/Users/ej/Downloads/maxi-doge-unified/src/routes/api/auth/session/+server.ts:3`
  - `/Users/ej/Downloads/maxi-doge-unified/src/routes/api/auth/wallet/+server.ts:3`
- Needed API binding:
...
- Local write point: `/Users/ej/Downloads/maxi-doge-unified/src/routes/arena/+page.svelte:830`
- Match API exists: `/Users/ej/Downloads/maxi-doge-unified/src/routes/api/matches/+server.ts:132`
- Needed:
  - call `POST /api/matches` on result
  - add `POST /api/pnl` for `addPnLEntry` path

3. Quick trade open/close clicks are local only
- Trade action source: `/Users/ej/Downloads/maxi-doge-unified/src/components/terminal/WarRoom.svelte:148`
- Local store mutations: `/Users/ej/Downloads/maxi-doge-unified/src/lib/stores/quickTradeStore.ts:83`
- Needed:
...
- Track click source: `/Users/ej/Downloads/maxi-doge-unified/src/components/terminal/WarRoom.svelte:136`
- Signal store local mutation: `/Users/ej/Downloads/maxi-doge-unified/src/lib/stores/trackedSignalStore.ts:88`
- Needed:
...
- Modal publish action: `/Users/ej/Downloads/maxi-doge-unified/src/components/modals/CopyTradeModal.svelte:30`
- Local publish implementation: `/Users/ej/Downloads/maxi-doge-unified/src/lib/stores/copyTradeStore.ts:125`
- Needed:
...
- Chat dispatch: `/Users/ej/Downloads/maxi-doge-unified/src/components/terminal/IntelPanel.svelte:304`
- Chat state local only: `/Users/ej/Downloads/maxi-doge-unified/src/routes/terminal/+page.svelte:164`
- Needed:
  - `POST /api/chat/messages`
  - `GET /api/chat/messages?channel=terminal`

7. Predict vote clicks are local state only
- Vote click: `/Users/ej/Downloads/maxi-doge-unified/src/components/terminal/PredictPanel.svelte:30`
- Local vote storage only: `/Users/ej/Downloads/maxi-doge-unified/src/lib/stores/predictStore.ts:96`
- Needed:
...
- Settings mutation: `/Users/ej/Downloads/maxi-doge-unified/src/routes/settings/+page.svelte:30`
- Reset action: `/Users/ej/Downloads/maxi-doge-unified/src/routes/settings/+page.svelte:41`
- Needed:
  - `PUT /api/preferences`
  - `GET /api/preferences`
...
- Avatar/name edit: `/Users/ej/Downloads/maxi-doge-unified/src/routes/passport/+page.svelte:110`
- Needed:
  - `PATCH /api/profile`
  - `PUT /api/ui-state` (active tab)

10. Notifications tray clicks are memory-only store
- Tray actions: `/Users/ej/Downloads/maxi-doge-unified/src/components/shared/NotificationTray.svelte:24`
- Store is volatile writable array: `/Users/ej/Downloads/maxi-doge-unified/src/lib/stores/notificationStore.ts:42`
- Needed:
...
- Reaction click: `/Users/ej/Downloads/maxi-doge-unified/src/routes/live/+page.svelte:111`
- Needed:
...
- No click handlers bound: `/Users/ej/Downloads/maxi-doge-unified/src/components/terminal/IntelPanel.svelte:181`
- Needed:
...
- Source: `/Users/ej/Downloads/maxi-doge-unified/src/routes/signals/+page.svelte:158`
...
- Source: `/Users/ej/Downloads/maxi-doge-unified/src/routes/+page.svelte:252` and `/Users/ej/Downloads/maxi-doge-unified/src/routes/+page.svelte:266`
...
- Source: `/Users/ej/Downloads/maxi-doge-unified/src/components/terminal/IntelPanel.svelte:181`
- Gap: missing `on:click`

4. Header back button can fail on direct-entry sessions
- Source: `/Users/ej/Downloads/maxi-doge-unified/src/components/layout/Header.svelte:100`
...
- Source: `/Users/ej/Downloads/maxi-doge-unified/src/routes/arena/+page.svelte:1002`
...
- Source: `/Users/ej/Downloads/maxi-doge-unified/src/routes/holdings/+page.svelte:5`
