...
3. Settings reset key mismatch: one reset path clears `agentData` instead of `maxidoge_agents`.
...
| `src/routes/settings/+page.svelte` | 307 | P1 | Reset key mismatch risk (agentData vs maxidoge_agents) |
