...
4. `docs/design-docs/arena-domain-model.md`
   - Local canonical Arena/Arena War semantics.
5. `docs/design-docs/learning-loop.md`
   - Local canonical ORPO/RAG/Passport learning loop.
6. `docs/FRONTEND_REFACTOR_EXECUTION_DESIGN_2026-03-06.md`
   - Current structural refactor baseline.
7. `docs/overall-architecture-design.md`
