...
| --- | --- | --- | --- | --- |
| `context-retrieve` | context-api | `terminal, arena, community, api` | `read-only` | `retrieve:query` |
| `coord-claim` | coordination | `terminal, arena, community, api` | `writes-generated` | `coord:claim` |
| `registry-search` | context-api | `terminal, arena, community, api` | `read-only` | `registry:query` |
