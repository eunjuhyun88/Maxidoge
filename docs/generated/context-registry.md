...
- Publish tags: `stockclaw, context-kit`

## Surfaces

| Surface | Label | Spec | Routes |
| --- | --- | --- | --- |
| `terminal` | Terminal — Intel & Action | `docs/product-specs/terminal.md` | /terminal |
| `arena` | Arena — Decision Loop | `docs/product-specs/arena.md` | /arena, /arena-v2, /arena-war |
| `community` | Community — Social & Signals | `docs/product-specs/community.md` | /signals, /live |
| `api` | API — Server Contracts | `docs/product-specs/api.md` | /api |
...
| `docs/product-specs/terminal.md` | surface-terminal | surface-canonical |
| `docs/product-specs/arena.md` | surface-arena | surface-canonical |
| `docs/product-specs/community.md` | surface-community | surface-canonical |
| `docs/product-specs/api.md` | surface-api | surface-canonical |
...
| `docs:refresh` | docs | `node scripts/dev/refresh-generated-context.mjs` |
| `docs:refresh:check` | docs | `node scripts/dev/refresh-generated-context.mjs --check` |
...
| --- | --- | --- | --- |
| `implementer` | implementer | `terminal` | `agents/implementer.json` |
| `planner` | planner | `terminal` | `agents/planner.json` |
| `reviewer` | reviewer | `terminal` | `agents/reviewer.json` |

## Tools

| Tool | Scope | Surfaces | Manifest |
| --- | --- | --- | --- |
| `context-retrieve` | context-api | `terminal, arena, community, api` | `tools/context-retrieve.json` |
| `coord-claim` | coordination | `terminal, arena, community, api` | `tools/coord-claim.json` |
| `registry-search` | context-api | `terminal, arena, community, api` | `tools/registry-search.json` |
