...
| --- | --- | --- | --- | --- |
| `implementer` | implementer | `terminal` | `agents/implementer.json` | `src/, .agent-context/, docs/AGENT_WATCH_LOG.md` |
| `planner` | planner | `terminal` | `agents/planner.json` | `docs/exec-plans/active/, .agent-context/, docs/AGENT_WATCH_LOG.md` |
| `reviewer` | reviewer | `terminal` | `agents/reviewer.json` | `.agent-context/, docs/AGENT_WATCH_LOG.md` |
